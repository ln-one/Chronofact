...
const shouldBypassLimoraAuth =
  import.meta.env.VITE_BYPASS_LIMORA_AUTH === 'true'
...
const mockOrganization: LimoraOrganization = {
  id: 'org_chronofact_demo',
  name: 'Chronofact 演示空间',
}

const mockMembership: LimoraMembership = {
  id: 'mem_chronofact_demo',
  organizationId: mockOrganization.id,
  identityId: 'identity_dev_user',
  permissions: [...chronofactEvidencePermissions],
  organization: mockOrganization,
}

const mockSession: LimoraCurrentSession = {
  session: {
    id: 'session_dev_bypass',
    userId: 'identity_dev_user',
    expiresAt: new Date(Date.now() + 24 * 60 * 60 * 1000).toISOString(),
  },
  identity: {
    id: 'identity_dev_user',
